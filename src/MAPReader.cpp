...
////////////////////////////////////////////////////////////////////////////////
/// @brief Open a map file and read or map the file content to memory
/// @param lpszFileName  Path name of file to open.
/// @param dwSize Out variable to receive size of file.
/// @param lpMapAddr The pointer to memory address with file content
/// @return enum value of OPEN_FILE_ERROR
/// @author TQN
/// @date 2004.09.12
////////////////////////////////////////////////////////////////////////////////
MapFile::MAPResult MapFile::openMAP(const char * fileName, char * &mapAddr, size_t &mapSize)
{
    // Set default values for output parameters
    mapAddr = NULL;
    mapSize = INVALID_MAPFILE_SIZE;
    ...
    mapSize = GetFileSize(hFile, NULL);
    if ((INVALID_MAPFILE_SIZE == mapSize) || (0 == mapSize))
    {
        // File too large or empty
        CloseHandle(hFile);
        return ((0 == mapSize) ? FILE_EMPTY_ERROR : OS_ERROR);
    }
    ...
    mapAddr = (LPSTR) MapViewOfFile(hMap, FILE_MAP_READ, 0, 0, mapSize);
    if (NULL == mapAddr)
    {
        CloseHandle(hMap);
        return OS_ERROR;
    ...
    mapAddr = (char *)std::malloc(mapSize+16);
    ...
    std::memset(mapAddr + mapSize, 0, 16);
    if (std::fread(mapAddr, mapSize, 1, f) != 1)
    {
        fclose(f);
        return OS_ERROR;
    }
    ...
    if (NULL != memchr(mapAddr, 0, mapSize))
    {
...
/// @date 2004.09.12
////////////////////////////////////////////////////////////////////////////////
void MapFile::closeMAP(char * mapAddr)
{
#ifdef WIN32
    UnmapViewOfFile(mapAddr);
#else
